...
public class glibc_printf_test
{
	...
	[TestCase(" -123.456"             , "%9.3f"   , -123.456                  , TestName="Negative float"                 ) ]
	...
	public void digital_test ([Range(0,15)] int testcase) {
		...
		string format = SPrintF.sprintf("|%s6d |%s6o |%s6x |%s6X |%s6u |\n", prefix, prefix, prefix, prefix, prefix);
	...
	static readonly Tuple<string,double>[] float_test_expected = {
		new Tuple<string,double>("|      0.0000|  0.0000e+00|           0|\n",0.0),
		new Tuple<string,double>("|      1.0000|  1.0000e+00|           1|\n",1.0),
		new Tuple<string,double>("|     -1.0000| -1.0000e+00|          -1|\n",-1.0),
		new Tuple<string,double>("|    100.0000|  1.0000e+02|         100|\n",100.0),
		new Tuple<string,double>("|   1000.0000|  1.0000e+03|        1000|\n",1000.0),
		new Tuple<string,double>("|  10000.0000|  1.0000e+04|       1e+04|\n",10000.0),
		new Tuple<string,double>("|  12345.0000|  1.2345e+04|   1.234e+04|\n",12345.0),
		new Tuple<string,double>("| 100000.0000|  1.0000e+05|       1e+05|\n",100000.0),
		new Tuple<string,double>("| 123456.0000|  1.2346e+05|   1.235e+05|\n",123456.0),
	};
